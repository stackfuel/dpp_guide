...
1. **GitHub Account**: Du solltest einen GitHub Account haben, um dein Projekt zu hosten und mit anderen zu teilen. Melde dich dafür [hier an](https://github.com).
2. **Git Installation**: Stelle sicher, dass Git auf deinem Computer installiert ist. Folge dazu dem Abschnitt **Installation von Git** in unserem [Leitfaden für Git](./git_guide.md).
